...
const T = {
    es: {
        ...
        about_text1: "Con más de 15 años en la industria pesada, he construido una trayectoria que conecta la operación de planta con la estrategia de transformación digital. Comencé liderando equipos de producción y optimización en minería, energía y manufactura, y esa base operativa hoy me permite dirigir iniciativas de IA industrial y DataOps con una visión que entiende tanto el negocio como la tecnología.",
        about_text2: "Actualmente lidero proyectos de consultoría y ejecución para clientes en toda Latinoamérica, incluyendo Brasil y México, trabajando en conjunto con vendors de tecnología de frontera de Estados Unidos y Europa. Esta exposición internacional me ha hecho fluido en español, inglés y portugués, y sobre todo me ha dado la capacidad de traducir lo que es posible con tecnologías de Industria 4.0 e IA a lo que realmente genera valor en el contexto operativo de nuestra región.",
        ...
        tech_langgraph: "LangGraph", tech_crewai: "CrewAI",
    ...
    en: {
        ...
        section_technologies: "Stack",
        about_text1: "With over 15 years in heavy industry, I have built a career that connects plant operations with digital transformation strategy. I started leading production and optimization teams in mining, energy, and manufacturing, and that operational foundation now allows me to direct industrial AI and DataOps initiatives with a vision that understands both the business and the technology.",
        about_text2: "I currently lead consulting and execution projects for clients across Latin America, including Brazil and Mexico, working alongside frontier technology vendors from the United States and Europe. This international exposure has made me fluent in Spanish, English, and Portuguese, and most importantly, it has given me the ability to translate what is possible with Industry 4.0 and AI technologies into what actually creates value in the operational context of our region.",
    ...
    pt: {
        ...
        section_technologies: "Stack",
        about_text1: "Com mais de 15 anos na indústria pesada, construí uma trajetória que conecta a operação de planta com a estratégia de transformação digital. Comecei liderando equipes de produção e otimização em mineração, energia e manufatura, e essa base operacional hoje me permite dirigir iniciativas de IA industrial e DataOps com uma visão que entende tanto o negócio quanto a tecnologia.",
        about_text2: "Atualmente lidero projetos de consultoria e execução para clientes em toda a América Latina, incluindo Brasil e México, trabalhando em conjunto com vendors de tecnologia de fronteira dos Estados Unidos e Europa. Essa exposição internacional me tornou fluente em espanhol, inglês e português, e sobretudo me deu a capacidade de traduzir o que é possível com tecnologias de Indústria 4.0 e IA no que realmente gera valor no contexto operacional da nossa região.",
